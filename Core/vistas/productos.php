...
<div class="row">
        ...
        <div class="form-group col-sm-3 col-xs-12">
          ...
          <input type="text" name="nombre_producto" id="nombre_producto" class="form-control" placeholder="Ingresar descripcion" 
...
<div class="card card-navy" id="formularioregistros">  
  ...
  <div class="card-header" style="background: #000000; color: white; border-top: 4px solid #fd7e14;">
    <b>Formulario de productos</b>
    <button class="btn btn-danger float-right" onclick="limpiarFormReg();">
    <i class="fa fa-eraser"></i>Limpiar
    </button>
  </div>
  ...
  <!--===================== Formulario De Registro y Edicion =====================-->
      <form name="formularioREG_EDIT" id="formularioREG_EDIT" method="POST">
        <div class="card-body"> 
          <div class="row">
          <!--======== Campos ocultos ========-->
          <input type="hidden" name="id_producto" id="id_producto" class="form-control" readonly> 
        </div>

        <div class="row">
          <div class="form-group col-sm-3 col-xs-12">
            <label>Nombre del producto</label>
            <input type="text" name="nombre_producto" id="nombre_productoR" class="form-control" placeholder="Ingresar descripcion" 
            maxlength="255" required> 
          </div>
        </div>
        ...
        <div class="row">
          <div class="form-group col-sm-3 col-xs-12">
            ...
            <input type="text" name="stock_actual" id="stock_actualR" class="form-control" placeholder="Ingresar stock actual" 
            maxlength="20" required> 
          </div>

          <div class="form-group col-md-3 col-sm-6 col-xs-1">
            <label>Tipo de unidad</label>
              <select name="tipo_unidad" id="tipo_unidadR" class="form-control">
                 <option value="">Seleccione</option>
                 <option value="unidades">Por Unidades</option>
                 <option value="rollos">Por Rollos</option>
                 <option value="metros">Por Metros</option>
             </select>
          </div>

          <div class="form-group col-sm-3 col-xs-12">
            <label>Stock Minimo</label>
            <input type="text" name="stock_minimo" id="stock_minimoR" class="form-control" placeholder="Ingresar stock minimo" 
            maxlength="20" required> 
          </div>
        ...
        <div class="form-group col-sm-3 col-xs-12">
          <label>Pertenece a:</label>
            <select aria-label="Default select example" name="id_sub_categoria" id="id_sub_categoriaR" class="form-control">
            </select>
        </div>
        </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/productos.js<?php echo '?r='.date('Y-m-d H:i:s');?>"></script>
</body>
</html>
<?php 
ob_end_flush();
